window.addEventListener("load", () => {
    ...
    const container3 = document.getElementById("our-product-section-3");
    const container4 = document.getElementById("our-product-section-4");
    ...
    fetch("http://localhost:3000/grid_images")
      ...
      fetch("http://localhost:3000/grid_images_3")
      .then(function (response) {
        return response.json();
      })
      .then(function (response) {
      ...
      fetch("http://localhost:3000/grid_images_4")
      .then(function (response) {
        return response.json();
      })
      .then(function (response) {
